...
def generate_launch_description():
    # Các arg dùng chung (giữ nguyên, trừ model_path)
    launch_args = [
        DeclareLaunchArgument('model_path_cam0',
            default_value='/home/pi/yolov8sTplugTrain3.hef',
            description='HEF model path'),
        DeclareLaunchArgument('model_path_cam1',
            default_value='/home/pi/yolov8s_tplugnew.hef',
            description='HEF model path'),    
    ...
    cam0_args = {
        ...
        'model_path':   '/home/pi/yolov8s.hef',   # ⚡ model riêng cam0 yolov8s.hef  input_1_yolov8s.hef
    }
    cam1_args = {
        'video_device': '/dev/video4',
        'namespace':    'cam1',
        'camera_frame': 'cam1_frame',
        'model_path':   '/home/pi/input_1_yolov8s.hef',   # ⚡ model riêng cam1  input_1_yolov8s.hef 
    }
    # cam2_args = {
    #     'video_device': '/dev/video8',
    #     'namespace':    'cam2', 
    #     'camera_frame': 'cam2_frame',
    #     'model_path':   '/home/pi/yolov8sTplugTrain3',   # ⚡ model riêng cam1 yolov8s_Tplug.hef input_1_yolov8s.hef
    # }
    def make_cam_nodes(ns: str, dev: str, frame_id: str, model_path: str):
        # usb_cam
        usb = ComposableNode(
            package='usb_cam',
            ...
            parameters=[{
                ...
                'image_height': 720,
                'framerate': 10.0,
                'pixel_format': 'yuyv',   # đổi nếu cam không hỗ trợ mjpeg
        ...
        # yolo (model_path fix cứng theo từng cam)
        yolo = ComposableNode(
            ...
            namespace=f'/{ns}',
            parameters=[{
                'model_path': model_path,  # ⚡ dùng trực tiếp string
    ...
    container = ComposableNodeContainer(
        ...
        composable_node_descriptions=
            make_cam_nodes(
                cam0_args['namespace'],
                cam0_args['video_device'],
                cam0_args['camera_frame'],
                cam0_args['model_path']
            )
            +
            make_cam_nodes(
                cam1_args['namespace'],
                cam1_args['video_device'],
                cam1_args['camera_frame'],
                cam1_args['model_path']
            ),
            # +
            # make_cam_nodes(
            #     cam2_args['namespace'],
            #     cam2_args['video_device'],
            #     cam2_args['camera_frame'],
            #     cam2_args['model_path']
            # ),
        output='screen'
    )
